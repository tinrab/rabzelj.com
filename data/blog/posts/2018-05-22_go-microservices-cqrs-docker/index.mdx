...
<Note>
  The project's root directory is assumed to be `github.com/tinrab/meower` throughout this article.
  Every time a package is added to the Go source file, make sure dependencies are up to date by
  running `dep ensure`.
</Note>
