...
tags:
  - Go
description: Let's build an image recognition service in Go using pre-trained TensorFlow Inception-V3 model.
...
<Note>
  Imports are skipped for brevity. You can use
  [goimports](https://godoc.org/golang.org/x/tools/cmd/goimports) tool to add
  them. Your code editor most likely has a plugin for it.
</Note>
