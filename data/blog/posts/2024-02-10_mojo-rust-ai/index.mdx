...
It's often used for clickbait because it works.
...
You can achieve any performance you want, though you might have to write inline assembly or hints for the compiler.
Saying that Rust is slower than C, Zig, or Mojo is meaningless.

See further discussion here: https://reddit.com/r/rust/comments/1al8cuc/modular_community_spotlight_outperforming_rust/.

But, does anybody actually care about performance in AI? Why would Rust be considered for AI anyway?

In ML/AI, a significant portion of compute is performed with "tensors" on the GPU.
The source code is usually highly experimental, ugly and spaghettified.
