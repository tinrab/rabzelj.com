...
Let's say you want to generate some fake traffic for testing purposes.
You could sample requests in production and generating fake ones using [Markov chains](https://en.wikipedia.org/wiki/Markov_chain).
